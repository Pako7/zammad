# -*- encoding: utf-8 -*-
# stub: zendesk_api 2.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/zendesk/zendesk_api_client_rb/issues", "changelog_uri" => "https://github.com/zendesk/zendesk_api_client_rb/blob/v2.0.0/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/zendesk_api/2.0.0", "source_code_uri" => "https://github.com/zendesk/zendesk_api_client_rb/tree/v2.0.0", "wiki_uri" => "https://github.com/zendesk/zendesk_api_client_rb/wiki" } if s.respond_to? :metadata=
